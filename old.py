...
def echo_all(updates):
    for update in updates["result"]:
        ...
        elif text.startswith('/deletekeywords') or text.startswith('/remove') or text.startswith('видали') or text.startswith('/вилучи') or text.startswith('видали ключові слова') or text.startswith('видалити ключові слова') or text.startswith('delete') or text.startswith('видали') or text.startswith('видалити'):
